...
/* Generated from ../O.Common/BK9KSoftTest.dbd */
...
epicsShareExtern dset *pvar_dset_devAiKL3064;
epicsShareExtern dset *pvar_dset_devAiKL3102;
epicsShareExtern dset *pvar_dset_devAiKL3162;
epicsShareExtern dset *pvar_dset_devAiKL3202;
epicsShareExtern dset *pvar_dset_devAiKL3204;
epicsShareExtern dset *pvar_dset_devAiKL3222;
epicsShareExtern dset *pvar_dset_devAiKL3312;
epicsShareExtern dset *pvar_dset_devAiKL3314;
epicsShareExtern dset *pvar_dset_devAiKL3404;
epicsShareExtern dset *pvar_dset_devAiKL3408;
epicsShareExtern dset *pvar_dset_devAiKL3464;
epicsShareExtern dset *pvar_dset_devAiKL3468;
...
epicsShareExtern dset *pvar_dset_devAoKL2502;
epicsShareExtern dset *pvar_dset_devAoKL2512;
epicsShareExtern dset *pvar_dset_devAoKL4002;
epicsShareExtern dset *pvar_dset_devAoKL4132;
epicsShareExtern dset *pvar_dset_devBiSoft;
epicsShareExtern dset *pvar_dset_devBiSoftRaw;
epicsShareExtern dset *pvar_dset_devBiKL1104;
epicsShareExtern dset *pvar_dset_devBiKL1002;
epicsShareExtern dset *pvar_dset_devBiKL1124;
epicsShareExtern dset *pvar_dset_devBiKL1408;
epicsShareExtern dset *pvar_dset_devBiKL1488;
...
epicsShareExtern dset *pvar_dset_devBoKL2012;
epicsShareExtern dset *pvar_dset_devBoKL2114;
epicsShareExtern dset *pvar_dset_devBoKL2124;
epicsShareExtern dset *pvar_dset_devBoKL2408;
epicsShareExtern dset *pvar_dset_devBoKL2808;
epicsShareExtern dset *pvar_dset_devBoKL2622;
...
epicsShareExtern dset *pvar_dset_devLiBx9000Info;
...
epicsShareExtern dset *pvar_dset_devMbbiBx9000Info;
...
epicsShareExtern dset *pvar_dset_devSiBx9000Info;
...
static const char * const deviceSupportNames[70] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[70] = {
    ...
    pvar_dset_devAiKL3064,
    pvar_dset_devAiKL3102,
    pvar_dset_devAiKL3162,
    pvar_dset_devAiKL3202,
    pvar_dset_devAiKL3204,
    pvar_dset_devAiKL3222,
    pvar_dset_devAiKL3312,
    pvar_dset_devAiKL3314,
    pvar_dset_devAiKL3404,
    pvar_dset_devAiKL3408,
    pvar_dset_devAiKL3464,
    pvar_dset_devAiKL3468,
    pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback,
    pvar_dset_devAoKL2502,
    pvar_dset_devAoKL2512,
    pvar_dset_devAoKL4002,
    pvar_dset_devAoKL4132,
    pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw,
    pvar_dset_devBiKL1104,
    pvar_dset_devBiKL1002,
    pvar_dset_devBiKL1124,
    pvar_dset_devBiKL1408,
    pvar_dset_devBiKL1488,
    pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime,
    pvar_dset_devBoKL2012,
    pvar_dset_devBoKL2114,
    pvar_dset_devBoKL2124,
    pvar_dset_devBoKL2408,
    pvar_dset_devBoKL2808,
    pvar_dset_devBoKL2622,
    pvar_dset_devCalcoutSoft,
    pvar_dset_devCalcoutSoftCallback,
    pvar_dset_devEventSoft,
    pvar_dset_devLiSoft,
    pvar_dset_devLiGeneralTime,
    pvar_dset_devLiBx9000Info,
    pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback,
    pvar_dset_devMbbiSoft,
    pvar_dset_devMbbiSoftRaw,
    pvar_dset_devMbbiBx9000Info,
...
epicsShareExtern drvet *pvar_drvet_drvModBusTCPClnt;
epicsShareExtern drvet *pvar_drvet_drvBx9000_MBT;
...
static struct drvet *drvsl[2] = {
    pvar_drvet_drvModBusTCPClnt,
    pvar_drvet_drvBx9000_MBT
};

epicsShareExtern void (*pvar_func_asSub)(void);
epicsShareExtern void (*pvar_func_drvBx9000_MBT_Register)(void);
...
int BK9KSoftTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/reg/g/pcds/package/epics/3.14-dev/modules/Bx9000_MBT/current";
    ...
    registerDevices(pbase, 70, deviceSupportNames, devsl);
    registerDrivers(pbase, 2, driverSupportNames, drvsl);
    (*pvar_func_asSub)();
    (*pvar_func_drvBx9000_MBT_Register)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"BK9KSoftTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    BK9KSoftTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
